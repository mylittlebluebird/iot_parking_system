...
int main(int argc, char *argv[])
{
		...
		CLIENT_INFO client_info[MAX_CLNT] = {{0,-1,"","parking_bt","PASSWD"}, \
				{0,-1,"","parking_db","PASSWD"},  {0,-1,"","parking_sensor","PASSWD"}, \
				{0,-1,"","parking_management","PASSWD"},  {0,-1,"","5","PASSWD"}, \
				{0,-1,"","aduino1","PASSWD"},  {0,-1,"","7","PASSWD"}, \
